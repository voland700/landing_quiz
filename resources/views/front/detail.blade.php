<div class="detail show" id="product">
    <div class="detail_closet"><span class="detail_closet_back" id="detailBack">Вернуться назад</span> <span class="detail_closet_btn close" id="detailClosed"></span></div>
